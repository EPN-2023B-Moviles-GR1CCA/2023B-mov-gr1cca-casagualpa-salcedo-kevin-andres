...
class Ddepartamento_edicion : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(codigoUnicoCocineroEdicion != null){
            ...
            BDD.bddAplicacion!!.consultarDepartamentoPorCodigoUnico(codigoUnicoCocineroEdicion)
...
//                    mostrarSnackbar(codigoUnico.text.toString())
                    if(validarCampos(codigoUnico, nombre, apellido, edad, fechaContratacion, salario, isMainChef)){
                        ...
                        BDD.bddAplicacion!!.actualizarDepartamentoPorCodigoUnico(datosActualizados)
